-------------------------------------------------------------------------------
Test set: org.xidea.lite.test.AutoLazyWidgetTest
-------------------------------------------------------------------------------
Tests run: 1, Failures: 0, Errors: 1, Skipped: 0, Time elapsed: 1.071 sec <<< FAILURE!
initializationError(org.xidea.lite.test.AutoLazyWidgetTest)  Time elapsed: 0.006 sec  <<< ERROR!
java.lang.ExceptionInInitializerError
	at org.xidea.lite.test.AutoSyntaxTest.loadCases(AutoSyntaxTest.java:138)
	at org.xidea.lite.test.AutoSyntaxTest.getParams(AutoSyntaxTest.java:72)
	at org.xidea.lite.test.AutoLazyWidgetTest.getParams(AutoLazyWidgetTest.java:32)
...
Caused by: java.lang.RuntimeException: javax.script.ScriptException: ReferenceError: "module" is not defined in <eval> at line number 140
	at org.xidea.lite.test.LiteTest.<clinit>(LiteTest.java:113)
	... 34 more
Caused by: javax.script.ScriptException: ReferenceError: "module" is not defined in <eval> at line number 140
	...
	at org.xidea.lite.test.LiteTest.<clinit>(LiteTest.java:105)
	... 34 more
Caused by: <eval>:140 ReferenceError: "module" is not defined
	...
	at jdk.nashorn.internal.scripts.Script$\^eval\_._L137(<eval>:140)
	at jdk.nashorn.internal.scripts.Script$\^eval\_._L22$requireAbs(<eval>:51)
	at jdk.nashorn.internal.scripts.Script$\^eval\_._L22$requireMock(<eval>:126)
	at jdk.nashorn.internal.scripts.Script$\^eval\_.scopeCall(<eval>)
	at jdk.nashorn.internal.scripts.Script$\^eval\_._L22$initPath(<eval>:81)
	at jdk.nashorn.internal.scripts.Script$\^eval\_._L22$requireAbs(<eval>:26)
	at jdk.nashorn.internal.scripts.Script$\^eval\_._L22$requireMock(<eval>:126)
	at jdk.nashorn.internal.scripts.Script$\^eval\_.scopeCall(<eval>)
